#!/bin/bash
#SBATCH --job-name=genome_gene_edges
#SBATCH --output=/fh/fast/srivatsan_s/grp/SrivatsanLab/Dustin/logs/1.6_genome_gene_edges_%j.out
#SBATCH --error=/fh/fast/srivatsan_s/grp/SrivatsanLab/Dustin/logs/1.6_genome_gene_edges_%j.err
#SBATCH --time=4:00:00
#SBATCH --mem=64G
