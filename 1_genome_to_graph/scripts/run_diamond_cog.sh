...
#SBATCH --array=0-7663%100
#SBATCH --cpus-per-task=4
#SBATCH --mem=8G
#SBATCH --time=30:00
#SBATCH --partition=campus-new

# DIAMOND COG Annotation for gene predictions
# Updated to use current directory structure

# Configuration
GENE_DIR="/fh/fast/srivatsan_s/grp/SrivatsanLab/Dustin/organism_scale_modelling/1_genome_to_graph/intermediate/protein/gene_predictions"
...
LOG_DIR="/fh/fast/srivatsan_s/grp/SrivatsanLab/Dustin/organism_scale_modelling/1_genome_to_graph/logs"
...
GENOME_ID=$(basename "${PROTEIN_FILE}" _genes.faa)
