#!/bin/bash
#SBATCH --job-name=6mer_profile
#SBATCH --output=../../logs/1.1_6mer_profile_%A_%a.out
#SBATCH --error=../../logs/1.1_6mer_profile_%A_%a.err
...
#
# submit_6mer_array.sh
# SLURM array job to generate 6-mer profiles for all 7,664 bacterial genomes
#
# Usage: sbatch submit_6mer_array.sh
#
...
# Run 6-mer profiling
bash "$SCRIPT_DIR/generate_6mer_profiles.sh" "$GENOME_FILE" "$OUTPUT_DIR"
