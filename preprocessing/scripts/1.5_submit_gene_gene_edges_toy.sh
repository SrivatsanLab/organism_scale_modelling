#!/bin/bash
#SBATCH --job-name=gene_gene_toy
#SBATCH --output=/fh/fast/srivatsan_s/grp/SrivatsanLab/Dustin/logs/1.5_gene_gene_edges_toy_%j.out
#SBATCH --error=/fh/fast/srivatsan_s/grp/SrivatsanLab/Dustin/logs/1.5_gene_gene_edges_toy_%j.err
